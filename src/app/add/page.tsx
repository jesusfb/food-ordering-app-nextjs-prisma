                ...
                <form className="flex flex-col flex-wrap gap-2 w-full">
                    ...
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <div className="flex justify-between mt-2 flex-wrap">
                            <button className="text-center bg-gray-800 text-gray-100 px-4 py-2 font-semibold uppercase hover:bg-gray-700 duration-300">Add option</button>
                            <p className="px-4 ring-1 ring-gray-800 flex items-center text-gray-800">Option 1</p>
                        </div>
                    </div>
