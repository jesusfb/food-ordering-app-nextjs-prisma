        ...
        <div className={`bg-black text-white py-8 my-6`}>
            <div className="w-full md:w-[80%] flex flex-col md:flex-row mx-auto">
                <div style={{flex: 1}} className="flex flex-col md:items-start items-center justify-center px-2 py-10">
                    ...
                    <p className="py-6 text-lg">Special offer for family size pizza, with extra 2l soda</p>
                    <button className={`bg-white text-black text-xl font-bold px-4 py-2 my-6 uppercase hover:bg-gray-200 duration-300`}>Order Now</button>
                </div>
